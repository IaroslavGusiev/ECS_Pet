...
public partial class GameEntity {
    ...
    public Code.Gameplay.Common.Time.CommonComponents.WorldPosition worldPosition { get { return (Code.Gameplay.Common.Time.CommonComponents.WorldPosition)GetComponent(GameComponentsLookup.WorldPosition); } }
    ...
    public GameEntity AddWorldPosition(UnityEngine.Vector3 newValue) {
        ...
        var component = (Code.Gameplay.Common.Time.CommonComponents.WorldPosition)CreateComponent(index, typeof(Code.Gameplay.Common.Time.CommonComponents.WorldPosition));
