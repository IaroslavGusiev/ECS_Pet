...
public partial class GameEntity {
    ...
    public Code.Gameplay.Statuses.StatusDuration statusDuration { get { return (Code.Gameplay.Statuses.StatusDuration)GetComponent(GameComponentsLookup.StatusDuration); } }
    ...
    public GameEntity AddStatusDuration(float newValue) {
        ...
        var component = (Code.Gameplay.Statuses.StatusDuration)CreateComponent(index, typeof(Code.Gameplay.Statuses.StatusDuration));
