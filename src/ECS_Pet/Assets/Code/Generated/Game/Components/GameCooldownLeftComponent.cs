...
public partial class GameEntity {
    ...
    public Code.Gameplay.Cooldowns.CooldownLeft cooldownLeft { get { return (Code.Gameplay.Cooldowns.CooldownLeft)GetComponent(GameComponentsLookup.CooldownLeft); } }
    ...
    public GameEntity AddCooldownLeft(float newValue) {
        ...
        var component = (Code.Gameplay.Cooldowns.CooldownLeft)CreateComponent(index, typeof(Code.Gameplay.Cooldowns.CooldownLeft));
