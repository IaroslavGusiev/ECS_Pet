...
public partial class GameEntity {
    ...
    public Code.Gameplay.Cooldowns.Cooldown cooldown { get { return (Code.Gameplay.Cooldowns.Cooldown)GetComponent(GameComponentsLookup.Cooldown); } }
    ...
    public GameEntity AddCooldown(float newValue) {
        ...
        var component = (Code.Gameplay.Cooldowns.Cooldown)CreateComponent(index, typeof(Code.Gameplay.Cooldowns.Cooldown));
