...
public partial class GameEntity {
    ...
    public Code.Gameplay.Combat.AttackRange attackRange { get { return (Code.Gameplay.Combat.AttackRange)GetComponent(GameComponentsLookup.AttackRange); } }
    ...
    public GameEntity AddAttackRange(float newValue) {
        ...
        var component = (Code.Gameplay.Combat.AttackRange)CreateComponent(index, typeof(Code.Gameplay.Combat.AttackRange));
