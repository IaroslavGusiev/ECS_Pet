...
public partial class GameEntity {
    ...
    public Code.Gameplay.Combat.TimeLeft timeLeft { get { return (Code.Gameplay.Combat.TimeLeft)GetComponent(GameComponentsLookup.TimeLeft); } }
    ...
    public GameEntity AddTimeLeft(float newValue) {
        ...
        var component = (Code.Gameplay.Combat.TimeLeft)CreateComponent(index, typeof(Code.Gameplay.Combat.TimeLeft));
