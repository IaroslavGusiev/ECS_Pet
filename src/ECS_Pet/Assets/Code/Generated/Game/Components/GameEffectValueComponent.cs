...
public partial class GameEntity {
    ...
    public Code.GameplayEffects.EffectValue effectValue { get { return (Code.GameplayEffects.EffectValue)GetComponent(GameComponentsLookup.EffectValue); } }
    ...
    public GameEntity AddEffectValue(float newValue) {
        ...
        var component = (Code.GameplayEffects.EffectValue)CreateComponent(index, typeof(Code.GameplayEffects.EffectValue));
